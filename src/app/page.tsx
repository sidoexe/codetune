      ...
      <div className='w-screen mt-[10vh] lg:mt-0 lg:h-screen flex justify-center'>
        <div className='flex text-center lg:text-left flex-col lg:flex-row justify-center items-center gap-10 lg:gap-40'>
          <div className='flex flex-col gap-y-10 sm:gap-y-5 w-4/5 lg:w-[40%] items-center lg:items-start md:items-right'>
            <div className={`${ClashDisplay.className} text-5xl sm:text-6xl font-semibold`}>
              <h1>Code &</h1>
              <h1>Groove With</h1>
          ...
          <div className={`${ClashDisplay.className} font-semibold xl:px-28`}>
            <Player />
          </div>
        </div>
      </div>
      <div className=''>
        <h1 className={`${ClashDisplay.className} text-3xl sm:text-5xl font-semibold text-center gradient-codetune-center mt-10 sm:mt-16`}>Change Stations</h1>
        <div className={`${ClashDisplay.className} text-xl font-normal flex justify-center items-center mt-24 mb-24`}>
          <Stations />
        </div>
      </div>
      <div>
        <h1 className={`${ClashDisplay.className} font-light text-xl mb-8 text-center`}>© 2023 CodeTune™</h1>
      </div>
    </div>
  )
}
